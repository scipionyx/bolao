...
function Spotlight(_a) {
  ...
  const { classes, cx } = Spotlight_styles['default']({ centered, maxWidth, topOffset, radius, zIndex }, { classNames, styles, name: "Spotlight" });
  ...
  }, /* @__PURE__ */ React__default.createElement(core.TextInput, __spreadProps(__spreadValues({
